...
const AsideHome = () => {
  ...
  const navLinkStyle = (path)=>{
    if (location.pathname == path) return "bg-gray-200 text-gray-700 mx-3 px-3 py-3 rounded-md ";
    return "mx-3 px-3 py-3 hover:bg-gray-100 rounded-md";
  }

  return (
    <aside className="bg-white w-[16rem] relative h-full min-h-screen border-r-2 overflow-auto">
      ...
      <div className="flex justify-center">
        <Link onClick={toggleMenu} to={"/projects"}>
          <img
            ...
            height={90}
            alt="jabbits-logo"
            className="border-b-2 border-black py-10"
          />
        </Link>
      </div>
