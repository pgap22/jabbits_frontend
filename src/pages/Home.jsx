          ...
          <div className="home-task">
            <Task
              ...
              tarea={{
                ...
                descripcion: 'Crear un custom hook que obtenga los valores de la API',
                tags: [
                  { nombre: "Alta", color: "#a3a3a3"},
                  { nombre: "Pendiente", color: "#eab308"},
                ],
              }}
            />
          </div>
...
const Footer = () => {
  return (
    <div className="w-full text-center p-4 dark:border-t dark:border-white bg-black text-white">
